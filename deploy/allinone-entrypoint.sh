...
aviso ""
aviso "El estado vive en /var/lib/ods. Si NO lanzaste esto con un volumen con"
aviso "nombre, desaparece al borrar el contenedor y volverás al asistente:"
aviso "  docker run -p 8080:8080 -v ods-datos:/var/lib/ods <imagen>"
aviso ""
aviso "Desde dentro no se puede saber si lo hiciste, así que esto se dice"
aviso "siempre. Si ya usas un volumen con nombre, ignóralo."
aviso "======================================================================"
aviso ""
